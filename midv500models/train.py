...
from pytorch_lightning import seed_everthing
...
def main():
    args = get_args()
    seed_everthing(hparams['seed'], workers=True)
    ...
    logger = NeptuneLogger(
        api_key=os.environ["NEPTUNE_API_TOKEN"], #export NEPTUNE_API_TOKEN="your credential"
        # api_key="NEPTUNE_API_TOKEN",
        project_name="mimicheng/midv500-segment", # change this
        experiment_name=f"{hparams['experiment_name']}",  # Optional,
        tags=["pytorch-lightning", "mlp", "midv500"],  # Optional,
        upload_source_files=[],
    )
